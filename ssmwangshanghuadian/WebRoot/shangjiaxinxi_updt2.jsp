...
-->
	...
	<body>
			<form action="updateShangjiaxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改店铺信息<input type="hidden" name="id" value="${shangjiaxinxi.id}" /></td>
						</tr>
		...
		<tr ><td width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
						...
						<script language="javascript">document.form1.shangjiahao.value='${shangjiaxinxi.shangjiahao}';</script>
	<script language="javascript">document.form1.mima.value='${shangjiaxinxi.mima}';</script>
	<script language="javascript">document.form1.xingming.value='${shangjiaxinxi.xingming}';</script>
	<script language="javascript">document.form1.xingbie.value='${shangjiaxinxi.xingbie}';</script>
	<script language="javascript">document.form1.nianling.value='${shangjiaxinxi.nianling}';</script>
	<script language="javascript">document.form1.lianxifangshi.value='${shangjiaxinxi.lianxifangshi}';</script>
	<script language="javascript">document.form1.beizhu.value='${shangjiaxinxi.beizhu}';</script>

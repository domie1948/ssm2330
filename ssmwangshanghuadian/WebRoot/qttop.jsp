		...
		<div class="wrap">
			<div class="nav">
				<ul>
					...
					<li id="m4" class="m"><h3><a href="spxxListtp.do">鲜花商城</a></h3></li>
				<!--	<li id="m4" class="m"><h3><a href="xwtzList.do?lb=购物须知">购物须知</a></h3></li>-->
					<li id="m4" class="m"><h3><a href="userreg.jsp">用户注册</a></h3></li>
					<li id="m4" class="m"><h3><a href="shangjiaxinxiadd.jsp">花店注册</a></h3></li>

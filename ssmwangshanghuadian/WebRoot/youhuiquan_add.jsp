...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addYouhuiquan.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加优惠券</td>
						</tr>
		...
		<tr ><td width="200">用户：</td><td><select name='yonghu' id='yonghu' style=' height:19px; border:solid 1px #000000; color:#666666'><%=connDbBean.hsggetoption("yonghuzhuce","yonghuming")%></select></td></tr>

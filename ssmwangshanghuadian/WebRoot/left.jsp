...
<body id="bg">
	...
	<div class="container">
		...
		<div class="leftsidebar_box"><a href="sy.php" target="main"><div class="line"><img src="images/coin01.png" />&nbsp;&nbsp;首页</div></a>
			<dl class="system_log">
				<dt>
					<img class="icon1" src="images/coin03.png" /><img class="icon2" src="images/coin04.png" /> 店铺信息管理<img class="icon3" src="images/coin19.png" /><img class="icon4" src="images/coin20.png" />
				</dt>
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="shangjiaxinxiList.do" target="main">店铺信息管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="yonghuzhuceList.do" target="main">注册用户管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="goumaijiluList.do" target="main">购物车管理</a><img class="icon5" src="images/coin21.png" />
				</dd>
		...
		<!--	<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xinwentongzhi_add.jsp?lb=购物须知" target="main">购物须知添加</a><img class="icon5" src="images/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="images/coin111.png" /><img class="coin22" src="images/coin222.png" /><a class="cks" href="xinwentongzhiList.do?lb=购物须知" target="main">购物须知查询</a><img class="icon5" src="images/coin21.png" />
				</dd>
			</dl>
			-->
			<dl class="system_log">

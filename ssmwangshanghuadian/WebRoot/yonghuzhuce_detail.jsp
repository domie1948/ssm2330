...
<td width='11%' height=44>余额：</td><td width='39%'>${yonghuzhuce.yue}</td>
</tr><tr>

<td width='11%' height=44>地址：</td><td width='39%'>${yonghuzhuce.dizhi}</td>
</tr><tr>

<td width='11%' height=100  >备注：</td><td width='39%' colspan=2 height=100 >${yonghuzhuce.beizhu}</td></tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()" />&nbsp;<input type=button name=Submit5 value=打印 onClick="javascript:window.print()" /></td></tr>

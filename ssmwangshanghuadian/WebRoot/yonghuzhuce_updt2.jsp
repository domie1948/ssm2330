...
-->
	...
	<body>
		...
		<tr ><td width="200">余额：</td><td><input name='yue' type='text' id='yue' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666'  readonly="readonly"/>&nbsp;<label id='clabelyue' />余额不可更改</td></tr>
	...
	<script language="javascript">document.form1.yue.value='${yonghuzhuce.yue}';</script>

...
<form action="addYonghuzhuce.do" name="form1" method="post">
		...
		<tr ><td width="200">出生年月：</td><td><input name='chushengnianyue' type='text' id='chushengnianyue' value='<%=connDbBean.getdate()%>' onblur='' readonly='readonly' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style='width:150px; height:24px; border:solid 1px #000000; color:#666666'/></td></tr>
		...
		<tr style="display:none"  ><td width="200">余额：</td><td><input name='yue' type='text' id='yue' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;<label id='clabelyue' />必需余额格式</td></tr>

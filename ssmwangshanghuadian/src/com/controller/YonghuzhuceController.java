...
//	分页查询
	...
	public String yonghuzhuceList(@RequestParam(value="page",required=false)String page,
			ModelMap map,HttpSession session,Yonghuzhuce yonghuzhuce, String yonghuming, String mima, String xingming, String xingbie, String chushengnianyue1,String chushengnianyue2, String QQ, String youxiang, String shouji, String yue, String touxiang, String dizhi, String beizhu, String issh){

...
public class db {
	...
	// private String sConnStr = "jdbc:microsoft:sqlserver://localhost:1433;databasename=ssmwshdAHB6"; 
	 
	 private String dbDriver="com.mysql.jdbc.Driver";
	 private String sConnStr = "jdbc:mysql://localhost:3306/ssmwshdAHB6?useUnicode=true&amp;amp;amp;amp;amp;characterEncoding=gb2312"; 
	
	 // private String dbDriver="net.sourceforge.jtds.jdbc.Driver";
	// private String sConnStr = "jdbc:jtds:sqlserver://127.0.0.1:1433;databaseName=ssmwshdAHB6"; 
	 ...
	 private List list;
	  ...
	  public List getShouyebht(){
			String sql = "select id,biaoti,shouyetupian from xinwentongzhi where leibie='购物须知' order by id desc";
			list = new ArrayList();
			try{
				connect=DriverManager.getConnection(sConnStr,nsa,nmm);
				Statement stmt=connect.createStatement();
